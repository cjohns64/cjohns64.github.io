...
*Analyzed exoplanet classification based on mass, radius, and orbital properties to identify common types.*

- Loaded the dataset and explored its structure.
- Cleaned missing values and converted mass/radius to Earth units.
- Based on thresholds, exoplanets can be categorized into types (e.g., Terrestrial, Super-Earth, Gas Giant).
- Bar charts and scatter plots visualized the distribution and relationships between mass, radius, and orbital properties.\
...
-   The visualizations and preprocessing steps help understand the classification and distribution of exoplanets.
-   The dataset's limitations include missing values and potential biases in detection methods.\

#### 2.2.  Is there a relationship between an exoplanet’s properties and its host star?

*To determine dependencies, we investigated correlations between stellar attributes (magnitude, mass, radius, and luminosity) and planetary characteristics (mass, radius, and orbital properties).*

**Data Cleaning & Standardization:**

-   Loaded and cleaned the dataset, handling missing values.
-   Converted planetary mass and radius to Earth-based units for consistency.\

**Statistical Analysis:**

-   Performed Pearson correlation analysis to check relationships between stellar magnitude and planetary attributes.
-   Conducted linear regression models using stellar magnitude as the predictor for exoplanet mass, radius, and orbital radius.
-   Scatter plots with trend lines were used to visualize relationships and identify patterns.\
...
-   **Limitations**
    ...
    -   **Missing Key Variables:** Stellar magnitude does not fully capture important host star properties.
        A better analysis can include:
...
-   Loaded and cleaned the dataset, handling missing values and applying log transformations to mass and radius for better distribution analysis.
...
**Residual Plot for Mass-Radius Regression**

![](./figures/Q3Fig3.png){style="float:right;" fig-alt=""}\

------------------------------------------------------------------------

###### 2.3.1.2. Exoplanet Mass Distribution

**Histogram of Exoplanet Mass Distribution (Linear Scale) – Frequency distribution of exoplanet masses.**

![](./figures/Q3Fig4.png){style="float:right;" fig-alt=""}\

**Density Plot for Exoplanet Masses (Linear Scale)**

![](./figures/Q3Fig5.png){style="float:right;" fig-alt=""}\
...
**Mass Distribution Across Clusters – Box plot showing cluster-wise mass variation.**

![](./figures/Q3Fig10.png){style="float:right;" fig-alt=""}\

------------------------------------------------------------------------

###### 2.3.1.4. Exoplanet Detection Methods

**Detection Method Distribution Across Clusters – Bar chart showing the count of detection methods in each cluster.**

![](./figures/Q3Fig11.png){style="float:right;" fig-alt=""}\
...
###### 2.3.1.5. Orbital Radius and Other Relationships

**Exoplanet Mass vs. Orbital Radius – Scatter plot showing orbital radius dependence on mass.**

![](./figures/Q3Fig14.png){style="float:right;" fig-alt=""}\

**Elbow Method to Determine Optimal Number of Clusters – Finding the best number of clusters.**
...
# also swap the axis range and aspectratio
